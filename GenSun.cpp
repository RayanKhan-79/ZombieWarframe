...
GenSun::GenSun(float interval)
    : Total_Animation_Time(0), switchTime(0.2), interval(interval), score(0), health(1)
{
...
void GenSun::UpdateAnimation(float deltaTime, float switchTime) {
...
void GenSun::scoreDisplay(sf::RenderWindow& window, sf::Font& font) {
...
void GenSun::isClick(sf::Event& event) {
